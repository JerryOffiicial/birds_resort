...
<div x-show="open"
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-500"
        ...
        <a href="https://wa.me/94XXXXXXXXX" target="_blank"
            class="flex items-center gap-5 rounded- px-6 py-5 bg-white/5 border border-white/10 hover:border-[var(--color-gold)] hover:bg-white/10 transition-all duration-500 group">
            <div class="w-10 h-10 flex items-center justify-center border border-white/20 shrink-0 group-hover:border-[var(--color-gold)] transition-colors duration-500">
        ...
        {{-- Book Now --}}
        <a href="/book"
            class="mt-4 bg-[var(--color-gold)] text-white font-sans text-[11px] tracking-[0.25em] uppercase px-6 py-5 rounded-4xl text-center hover:bg-white hover:text-[var(--color-primary-text)] transition-colors duration-500">
            Book Now
        </a>
